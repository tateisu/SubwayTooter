...
fun ViewManager.themedMediaRouteButton(theme: Int = 0): android.app.MediaRouteButton =
...
fun ViewManager.gestureOverlayView(): android.gesture.GestureOverlayView =
    gestureOverlayView() {}
...
fun ViewManager.themedGestureOverlayView(theme: Int = 0): android.gesture.GestureOverlayView =
...
fun Context.gestureOverlayView(): android.gesture.GestureOverlayView =
    gestureOverlayView() {}
...
fun Context.themedGestureOverlayView(theme: Int = 0): android.gesture.GestureOverlayView =
    themedGestureOverlayView(theme) {}
...
fun Activity.gestureOverlayView(): android.gesture.GestureOverlayView =
    gestureOverlayView() {}
...
fun Activity.themedGestureOverlayView(theme: Int = 0): android.gesture.GestureOverlayView =
    themedGestureOverlayView(theme) {}
...
fun ViewManager.extractEditText(): android.inputmethodservice.ExtractEditText =
    extractEditText() {}
...
fun ViewManager.themedExtractEditText(theme: Int = 0): android.inputmethodservice.ExtractEditText =
...
fun ViewManager.themedTvView(theme: Int = 0): android.media.tv.TvView =
    themedTvView(theme) {}

inline fun ViewManager.themedTvView(
    theme: Int = 0,
    init: (@AnkoViewDslMarker android.media.tv.TvView).() -> Unit,
...
fun ViewManager.themedGLSurfaceView(theme: Int = 0): android.opengl.GLSurfaceView =
...
fun ViewManager.themedSurfaceView(theme: Int = 0): android.view.SurfaceView =
    themedSurfaceView(theme) {}

inline fun ViewManager.themedSurfaceView(
    theme: Int = 0,
    init: (@AnkoViewDslMarker android.view.SurfaceView).() -> Unit,
...
fun ViewManager.themedTextureView(theme: Int = 0): android.view.TextureView =
    themedTextureView(theme) {}

inline fun ViewManager.themedTextureView(
    theme: Int = 0,
    init: (@AnkoViewDslMarker android.view.TextureView).() -> Unit,
...
fun ViewManager.themedViewStub(theme: Int = 0): android.view.ViewStub =
    themedViewStub(theme) {}

inline fun ViewManager.themedViewStub(
    theme: Int = 0,
    init: (@AnkoViewDslMarker android.view.ViewStub).() -> Unit,
...
fun ViewManager.themedWebView(theme: Int = 0): android.webkit.WebView =
    themedWebView(theme) {}

inline fun ViewManager.themedWebView(
    theme: Int = 0,
    init: (@AnkoViewDslMarker android.webkit.WebView).() -> Unit,
...
fun ViewManager.adapterViewFlipper(): android.widget.AdapterViewFlipper =
    adapterViewFlipper() {}
...
fun ViewManager.themedAdapterViewFlipper(theme: Int = 0): android.widget.AdapterViewFlipper =
...
fun Context.adapterViewFlipper(): android.widget.AdapterViewFlipper = adapterViewFlipper() {}
...
fun Context.themedAdapterViewFlipper(theme: Int = 0): android.widget.AdapterViewFlipper =
    themedAdapterViewFlipper(theme) {}
...
fun Activity.adapterViewFlipper(): android.widget.AdapterViewFlipper =
    adapterViewFlipper() {}
...
fun Activity.themedAdapterViewFlipper(theme: Int = 0): android.widget.AdapterViewFlipper =
    themedAdapterViewFlipper(theme) {}
...
fun ViewManager.autoCompleteTextView(): android.widget.AutoCompleteTextView =
...
fun ViewManager.themedAutoCompleteTextView(theme: Int = 0): android.widget.AutoCompleteTextView =
...
fun ViewManager.button(): android.widget.Button = button() {}
...
fun ViewManager.themedButton(theme: Int = 0): android.widget.Button = themedButton(theme) {}
...
fun ViewManager.button(text: CharSequence?): android.widget.Button {
...
fun ViewManager.themedButton(text: CharSequence?, theme: Int): android.widget.Button {
...
fun ViewManager.themedButton(text: Int, theme: Int): android.widget.Button {
    return ankoView(`$$Anko$Factories$Sdk28View`.BUTTON, theme) {
        setText(text)
    }
}
...
fun ViewManager.themedCalendarView(theme: Int = 0): android.widget.CalendarView =
...
fun Context.themedCalendarView(theme: Int = 0): android.widget.CalendarView =
    themedCalendarView(theme) {}
...
fun Activity.themedCalendarView(theme: Int = 0): android.widget.CalendarView =
    themedCalendarView(theme) {}
...
fun ViewManager.checkBox(): android.widget.CheckBox = checkBox() {}
...
fun ViewManager.themedCheckBox(theme: Int = 0): android.widget.CheckBox =
...
fun ViewManager.checkBox(text: CharSequence?): android.widget.CheckBox {
...
fun ViewManager.themedCheckBox(text: CharSequence?, theme: Int): android.widget.CheckBox {
...
fun ViewManager.themedCheckBox(text: Int, theme: Int): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk28View`.CHECK_BOX, theme) {
        setText(text)
    }
}
...
fun ViewManager.checkBox(text: CharSequence?, checked: Boolean): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk28View`.CHECK_BOX, theme = 0) {
        setText(text)
        setChecked(checked)
    }
...
fun ViewManager.checkBox(text: Int, checked: Boolean): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk28View`.CHECK_BOX, theme = 0) {
        setText(text)
        setChecked(checked)
    }
...
fun ViewManager.themedCheckedTextView(theme: Int = 0): android.widget.CheckedTextView =
...
fun ViewManager.themedChronometer(theme: Int = 0): android.widget.Chronometer =
...
fun ViewManager.datePicker(): android.widget.DatePicker = datePicker() {}
...
fun ViewManager.themedDatePicker(theme: Int = 0): android.widget.DatePicker =
    themedDatePicker(theme) {}

inline fun ViewManager.themedDatePicker(
    theme: Int = 0,
    init: (@AnkoViewDslMarker android.widget.DatePicker).() -> Unit,
): android.widget.DatePicker {
    return ankoView(`$$Anko$Factories$Sdk28View`.DATE_PICKER, theme) { init() }
}

fun Context.datePicker(): android.widget.DatePicker = datePicker() {}
inline fun Context.datePicker(init: (@AnkoViewDslMarker android.widget.DatePicker).() -> Unit): android.widget.DatePicker {
    return ankoView(`$$Anko$Factories$Sdk28View`.DATE_PICKER, theme = 0) { init() }
}

fun Context.themedDatePicker(theme: Int = 0): android.widget.DatePicker =
    themedDatePicker(theme) {}
...
fun Activity.datePicker(): android.widget.DatePicker = datePicker() {}
inline fun Activity.datePicker(init: (@AnkoViewDslMarker android.widget.DatePicker).() -> Unit): android.widget.DatePicker {
    return ankoView(`$$Anko$Factories$Sdk28View`.DATE_PICKER, theme = 0) { init() }
}

fun Activity.themedDatePicker(theme: Int = 0): android.widget.DatePicker =
    themedDatePicker(theme) {}
...
fun ViewManager.themedEditText(theme: Int = 0): android.widget.EditText =
...
fun ViewManager.editText(text: CharSequence?): android.widget.EditText {
...
fun ViewManager.themedEditText(text: CharSequence?, theme: Int): android.widget.EditText {
...
fun ViewManager.editText(text: Int): android.widget.EditText {
    return ankoView(`$$Anko$Factories$Sdk28View`.EDIT_TEXT, theme = 0) {
        setText(text)
    }
}
...
fun ViewManager.themedEditText(text: Int, theme: Int): android.widget.EditText {
    return ankoView(`$$Anko$Factories$Sdk28View`.EDIT_TEXT, theme) {
        setText(text)
    }
}
...
fun ViewManager.expandableListView(): android.widget.ExpandableListView =
    expandableListView() {}
...
fun ViewManager.themedExpandableListView(theme: Int = 0): android.widget.ExpandableListView =
    themedExpandableListView(theme) {}

inline fun ViewManager.themedExpandableListView(
    theme: Int = 0,
    init: (@AnkoViewDslMarker android.widget.ExpandableListView).() -> Unit,
): android.widget.ExpandableListView {
    return ankoView(`$$Anko$Factories$Sdk28View`.EXPANDABLE_LIST_VIEW, theme) { init() }
}

fun Context.expandableListView(): android.widget.ExpandableListView = expandableListView() {}
...
fun Context.themedExpandableListView(theme: Int = 0): android.widget.ExpandableListView =
    themedExpandableListView(theme) {}
...
fun Activity.expandableListView(): android.widget.ExpandableListView =
    expandableListView() {}
...
fun Activity.themedExpandableListView(theme: Int = 0): android.widget.ExpandableListView =
    themedExpandableListView(theme) {}
...
fun ViewManager.imageButton(): android.widget.ImageButton = imageButton() {}
...
fun ViewManager.themedImageButton(theme: Int = 0): android.widget.ImageButton =
...
fun ViewManager.imageButton(imageDrawable: android.graphics.drawable.Drawable?): android.widget.ImageButton {
...
fun ViewManager.imageButton(imageResource: Int): android.widget.ImageButton {
    return ankoView(`$$Anko$Factories$Sdk28View`.IMAGE_BUTTON, theme = 0) {
...
fun ViewManager.themedImageView(theme: Int = 0): android.widget.ImageView =
...
fun ViewManager.themedImageView(imageResource: Int, theme: Int): android.widget.ImageView {
    return ankoView(`$$Anko$Factories$Sdk28View`.IMAGE_VIEW, theme) {
        setImageResource(imageResource)
    }
}
...
fun ViewManager.themedListView(theme: Int = 0): android.widget.ListView =
...
fun Context.themedListView(theme: Int = 0): android.widget.ListView =
    themedListView(theme) {}
...
fun Activity.themedListView(theme: Int = 0): android.widget.ListView =
    themedListView(theme) {}
...
fun ViewManager.multiAutoCompleteTextView(): android.widget.MultiAutoCompleteTextView =
...
fun ViewManager.themedMultiAutoCompleteTextView(theme: Int = 0): android.widget.MultiAutoCompleteTextView =
...
fun ViewManager.numberPicker(): android.widget.NumberPicker = numberPicker() {}
...
fun ViewManager.themedNumberPicker(theme: Int = 0): android.widget.NumberPicker =
    themedNumberPicker(theme) {}

inline fun ViewManager.themedNumberPicker(
    theme: Int = 0,
    init: (@AnkoViewDslMarker android.widget.NumberPicker).() -> Unit,
): android.widget.NumberPicker {
    return ankoView(`$$Anko$Factories$Sdk28View`.NUMBER_PICKER, theme) { init() }
}

fun Context.numberPicker(): android.widget.NumberPicker = numberPicker() {}
inline fun Context.numberPicker(init: (@AnkoViewDslMarker android.widget.NumberPicker).() -> Unit): android.widget.NumberPicker {
    return ankoView(`$$Anko$Factories$Sdk28View`.NUMBER_PICKER, theme = 0) { init() }
}

fun Context.themedNumberPicker(theme: Int = 0): android.widget.NumberPicker =
    themedNumberPicker(theme) {}
...
fun Activity.numberPicker(): android.widget.NumberPicker = numberPicker() {}
inline fun Activity.numberPicker(init: (@AnkoViewDslMarker android.widget.NumberPicker).() -> Unit): android.widget.NumberPicker {
    return ankoView(`$$Anko$Factories$Sdk28View`.NUMBER_PICKER, theme = 0) { init() }
}

fun Activity.themedNumberPicker(theme: Int = 0): android.widget.NumberPicker =
    themedNumberPicker(theme) {}
...
fun ViewManager.themedProgressBar(theme: Int = 0): android.widget.ProgressBar =
...
fun ViewManager.quickContactBadge(): android.widget.QuickContactBadge =
    quickContactBadge() {}
...
fun ViewManager.themedQuickContactBadge(theme: Int = 0): android.widget.QuickContactBadge =
...
fun ViewManager.themedRadioButton(theme: Int = 0): android.widget.RadioButton =
...
fun ViewManager.themedRatingBar(theme: Int = 0): android.widget.RatingBar =
...
fun ViewManager.searchView(): android.widget.SearchView = searchView() {}
...
fun ViewManager.themedSearchView(theme: Int = 0): android.widget.SearchView =
...
fun Context.searchView(): android.widget.SearchView = searchView() {}
inline fun Context.searchView(init: (@AnkoViewDslMarker android.widget.SearchView).() -> Unit): android.widget.SearchView {
    return ankoView(`$$Anko$Factories$Sdk28View`.SEARCH_VIEW, theme = 0) { init() }
}

fun Context.themedSearchView(theme: Int = 0): android.widget.SearchView =
    themedSearchView(theme) {}
...
fun Activity.searchView(): android.widget.SearchView = searchView() {}
inline fun Activity.searchView(init: (@AnkoViewDslMarker android.widget.SearchView).() -> Unit): android.widget.SearchView {
    return ankoView(`$$Anko$Factories$Sdk28View`.SEARCH_VIEW, theme = 0) { init() }
}

fun Activity.themedSearchView(theme: Int = 0): android.widget.SearchView =
    themedSearchView(theme) {}
...
fun ViewManager.seekBar(): android.widget.SeekBar = seekBar() {}
...
fun ViewManager.themedSeekBar(theme: Int = 0): android.widget.SeekBar =
    themedSeekBar(theme) {}
...
fun ViewManager.themedSpace(theme: Int = 0): android.widget.Space = themedSpace(theme) {}
...
fun ViewManager.themedSpinner(theme: Int = 0): android.widget.Spinner =
    themedSpinner(theme) {}
...
fun Context.spinner(): android.widget.Spinner = spinner() {}
inline fun Context.spinner(init: (@AnkoViewDslMarker android.widget.Spinner).() -> Unit): android.widget.Spinner {
    return ankoView(`$$Anko$Factories$Sdk28View`.SPINNER, theme = 0) { init() }
}

fun Context.themedSpinner(theme: Int = 0): android.widget.Spinner = themedSpinner(theme) {}
...
fun Activity.spinner(): android.widget.Spinner = spinner() {}
inline fun Activity.spinner(init: (@AnkoViewDslMarker android.widget.Spinner).() -> Unit): android.widget.Spinner {
    return ankoView(`$$Anko$Factories$Sdk28View`.SPINNER, theme = 0) { init() }
}

fun Activity.themedSpinner(theme: Int = 0): android.widget.Spinner = themedSpinner(theme) {}
...
fun ViewManager.stackView(): android.widget.StackView = stackView() {}
...
fun ViewManager.themedStackView(theme: Int = 0): android.widget.StackView =
...
fun Context.stackView(): android.widget.StackView = stackView() {}
inline fun Context.stackView(init: (@AnkoViewDslMarker android.widget.StackView).() -> Unit): android.widget.StackView {
    return ankoView(`$$Anko$Factories$Sdk28View`.STACK_VIEW, theme = 0) { init() }
}

fun Context.themedStackView(theme: Int = 0): android.widget.StackView =
    themedStackView(theme) {}
...
fun Activity.stackView(): android.widget.StackView = stackView() {}
inline fun Activity.stackView(init: (@AnkoViewDslMarker android.widget.StackView).() -> Unit): android.widget.StackView {
    return ankoView(`$$Anko$Factories$Sdk28View`.STACK_VIEW, theme = 0) { init() }
}

fun Activity.themedStackView(theme: Int = 0): android.widget.StackView =
    themedStackView(theme) {}
...
fun ViewManager.switch(): android.widget.Switch = switch() {}
...
fun ViewManager.themedSwitch(theme: Int = 0): android.widget.Switch = themedSwitch(theme) {}
...
fun ViewManager.textClock(): android.widget.TextClock = textClock() {}
...
fun ViewManager.themedTextClock(theme: Int = 0): android.widget.TextClock =
...
fun ViewManager.textView(): android.widget.TextView = textView() {}
...
fun ViewManager.themedTextView(theme: Int = 0): android.widget.TextView =
...
fun ViewManager.textView(text: CharSequence?): android.widget.TextView {
...
fun ViewManager.themedTextView(text: CharSequence?, theme: Int): android.widget.TextView {
...
fun ViewManager.textView(text: Int): android.widget.TextView {
    return ankoView(`$$Anko$Factories$Sdk28View`.TEXT_VIEW, theme = 0) {
        setText(text)
    }
}
...
fun ViewManager.themedTextView(text: Int, theme: Int): android.widget.TextView {
    return ankoView(`$$Anko$Factories$Sdk28View`.TEXT_VIEW, theme) {
        setText(text)
    }
}
...
fun ViewManager.timePicker(): android.widget.TimePicker = timePicker() {}
...
fun ViewManager.themedTimePicker(theme: Int = 0): android.widget.TimePicker =
...
fun Context.timePicker(): android.widget.TimePicker = timePicker() {}
inline fun Context.timePicker(init: (@AnkoViewDslMarker android.widget.TimePicker).() -> Unit): android.widget.TimePicker {
    return ankoView(`$$Anko$Factories$Sdk28View`.TIME_PICKER, theme = 0) { init() }
}

fun Context.themedTimePicker(theme: Int = 0): android.widget.TimePicker =
    themedTimePicker(theme) {}
...
fun Activity.timePicker(): android.widget.TimePicker = timePicker() {}
inline fun Activity.timePicker(init: (@AnkoViewDslMarker android.widget.TimePicker).() -> Unit): android.widget.TimePicker {
    return ankoView(`$$Anko$Factories$Sdk28View`.TIME_PICKER, theme = 0) { init() }
}

fun Activity.themedTimePicker(theme: Int = 0): android.widget.TimePicker =
    themedTimePicker(theme) {}
...
fun ViewManager.toggleButton(): android.widget.ToggleButton = toggleButton() {}
...
fun ViewManager.themedToggleButton(theme: Int = 0): android.widget.ToggleButton =
...
fun ViewManager.videoView(): android.widget.VideoView = videoView() {}
...
fun ViewManager.themedVideoView(theme: Int = 0): android.widget.VideoView =
    themedVideoView(theme) {}

inline fun ViewManager.themedVideoView(
    theme: Int = 0,
    init: (@AnkoViewDslMarker android.widget.VideoView).() -> Unit,
): android.widget.VideoView {
    return ankoView(`$$Anko$Factories$Sdk28View`.VIDEO_VIEW, theme) { init() }
}

fun ViewManager.viewFlipper(): android.widget.ViewFlipper = viewFlipper() {}
...
fun ViewManager.themedViewFlipper(theme: Int = 0): android.widget.ViewFlipper =
...
fun Context.viewFlipper(): android.widget.ViewFlipper = viewFlipper() {}
inline fun Context.viewFlipper(init: (@AnkoViewDslMarker android.widget.ViewFlipper).() -> Unit): android.widget.ViewFlipper {
    return ankoView(`$$Anko$Factories$Sdk28View`.VIEW_FLIPPER, theme = 0) { init() }
}

fun Context.themedViewFlipper(theme: Int = 0): android.widget.ViewFlipper =
    themedViewFlipper(theme) {}
...
fun Activity.viewFlipper(): android.widget.ViewFlipper = viewFlipper() {}
inline fun Activity.viewFlipper(init: (@AnkoViewDslMarker android.widget.ViewFlipper).() -> Unit): android.widget.ViewFlipper {
    return ankoView(`$$Anko$Factories$Sdk28View`.VIEW_FLIPPER, theme = 0) { init() }
}

fun Activity.themedViewFlipper(theme: Int = 0): android.widget.ViewFlipper =
    themedViewFlipper(theme) {}
...
fun ViewManager.actionMenuView(): android.widget.ActionMenuView = actionMenuView() {}
...
fun ViewManager.themedActionMenuView(theme: Int = 0): android.widget.ActionMenuView =
...
fun Context.actionMenuView(): android.widget.ActionMenuView = actionMenuView() {}
inline fun Context.actionMenuView(init: (@AnkoViewDslMarker _ActionMenuView).() -> Unit): android.widget.ActionMenuView {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.ACTION_MENU_VIEW, theme = 0) { init() }
}

fun Context.themedActionMenuView(theme: Int = 0): android.widget.ActionMenuView =
    themedActionMenuView(theme) {}
...
fun Activity.actionMenuView(): android.widget.ActionMenuView = actionMenuView() {}
inline fun Activity.actionMenuView(init: (@AnkoViewDslMarker _ActionMenuView).() -> Unit): android.widget.ActionMenuView {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.ACTION_MENU_VIEW, theme = 0) { init() }
}

fun Activity.themedActionMenuView(theme: Int = 0): android.widget.ActionMenuView =
    themedActionMenuView(theme) {}
...
fun ViewManager.frameLayout(): android.widget.FrameLayout = frameLayout() {}
...
fun ViewManager.themedFrameLayout(theme: Int = 0): android.widget.FrameLayout =
...
fun Context.frameLayout(): android.widget.FrameLayout = frameLayout() {}
inline fun Context.frameLayout(init: (@AnkoViewDslMarker _FrameLayout).() -> Unit): android.widget.FrameLayout {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.FRAME_LAYOUT, theme = 0) { init() }
}

fun Context.themedFrameLayout(theme: Int = 0): android.widget.FrameLayout =
    themedFrameLayout(theme) {}
...
fun Activity.frameLayout(): android.widget.FrameLayout = frameLayout() {}
inline fun Activity.frameLayout(init: (@AnkoViewDslMarker _FrameLayout).() -> Unit): android.widget.FrameLayout {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.FRAME_LAYOUT, theme = 0) { init() }
}

fun Activity.themedFrameLayout(theme: Int = 0): android.widget.FrameLayout =
    themedFrameLayout(theme) {}
...
fun ViewManager.gridLayout(): android.widget.GridLayout = gridLayout() {}
...
fun ViewManager.themedGridLayout(theme: Int = 0): android.widget.GridLayout =
...
fun Context.gridLayout(): android.widget.GridLayout = gridLayout() {}
inline fun Context.gridLayout(init: (@AnkoViewDslMarker _GridLayout).() -> Unit): android.widget.GridLayout {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.GRID_LAYOUT, theme = 0) { init() }
}

fun Context.themedGridLayout(theme: Int = 0): android.widget.GridLayout =
    themedGridLayout(theme) {}
...
fun Activity.gridLayout(): android.widget.GridLayout = gridLayout() {}
inline fun Activity.gridLayout(init: (@AnkoViewDslMarker _GridLayout).() -> Unit): android.widget.GridLayout {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.GRID_LAYOUT, theme = 0) { init() }
}

fun Activity.themedGridLayout(theme: Int = 0): android.widget.GridLayout =
    themedGridLayout(theme) {}
...
fun ViewManager.gridView(): android.widget.GridView = gridView() {}
...
fun ViewManager.themedGridView(theme: Int = 0): android.widget.GridView =
...
fun Context.gridView(): android.widget.GridView = gridView() {}
inline fun Context.gridView(init: (@AnkoViewDslMarker _GridView).() -> Unit): android.widget.GridView {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.GRID_VIEW, theme = 0) { init() }
}

fun Context.themedGridView(theme: Int = 0): android.widget.GridView =
    themedGridView(theme) {}
...
fun Activity.gridView(): android.widget.GridView = gridView() {}
inline fun Activity.gridView(init: (@AnkoViewDslMarker _GridView).() -> Unit): android.widget.GridView {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.GRID_VIEW, theme = 0) { init() }
}

fun Activity.themedGridView(theme: Int = 0): android.widget.GridView =
    themedGridView(theme) {}
...
fun ViewManager.horizontalScrollView(): android.widget.HorizontalScrollView =
...
fun ViewManager.themedHorizontalScrollView(theme: Int = 0): android.widget.HorizontalScrollView =
...
fun Context.horizontalScrollView(): android.widget.HorizontalScrollView =
    horizontalScrollView() {}
...
fun Context.themedHorizontalScrollView(theme: Int = 0): android.widget.HorizontalScrollView =
    themedHorizontalScrollView(theme) {}
...
fun Activity.horizontalScrollView(): android.widget.HorizontalScrollView =
    horizontalScrollView() {}
...
fun Activity.themedHorizontalScrollView(theme: Int = 0): android.widget.HorizontalScrollView =
    themedHorizontalScrollView(theme) {}
...
fun ViewManager.imageSwitcher(): android.widget.ImageSwitcher = imageSwitcher() {}
...
fun ViewManager.themedImageSwitcher(theme: Int = 0): android.widget.ImageSwitcher =
...
fun Context.imageSwitcher(): android.widget.ImageSwitcher = imageSwitcher() {}
inline fun Context.imageSwitcher(init: (@AnkoViewDslMarker _ImageSwitcher).() -> Unit): android.widget.ImageSwitcher {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.IMAGE_SWITCHER, theme = 0) { init() }
}

fun Context.themedImageSwitcher(theme: Int = 0): android.widget.ImageSwitcher =
    themedImageSwitcher(theme) {}
...
fun Activity.imageSwitcher(): android.widget.ImageSwitcher = imageSwitcher() {}
inline fun Activity.imageSwitcher(init: (@AnkoViewDslMarker _ImageSwitcher).() -> Unit): android.widget.ImageSwitcher {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.IMAGE_SWITCHER, theme = 0) { init() }
}

fun Activity.themedImageSwitcher(theme: Int = 0): android.widget.ImageSwitcher =
    themedImageSwitcher(theme) {}
...
fun ViewManager.themedLinearLayout(theme: Int = 0): android.widget.LinearLayout =
...
fun Context.themedLinearLayout(theme: Int = 0): android.widget.LinearLayout =
    themedLinearLayout(theme) {}
...
fun Activity.themedLinearLayout(theme: Int = 0): android.widget.LinearLayout =
    themedLinearLayout(theme) {}
...
fun ViewManager.radioGroup(): android.widget.RadioGroup = radioGroup() {}
...
fun ViewManager.themedRadioGroup(theme: Int = 0): android.widget.RadioGroup =
...
fun Context.radioGroup(): android.widget.RadioGroup = radioGroup() {}
inline fun Context.radioGroup(init: (@AnkoViewDslMarker _RadioGroup).() -> Unit): android.widget.RadioGroup {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.RADIO_GROUP, theme = 0) { init() }
}

fun Context.themedRadioGroup(theme: Int = 0): android.widget.RadioGroup =
    themedRadioGroup(theme) {}
...
fun Activity.radioGroup(): android.widget.RadioGroup = radioGroup() {}
inline fun Activity.radioGroup(init: (@AnkoViewDslMarker _RadioGroup).() -> Unit): android.widget.RadioGroup {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.RADIO_GROUP, theme = 0) { init() }
}

fun Activity.themedRadioGroup(theme: Int = 0): android.widget.RadioGroup =
    themedRadioGroup(theme) {}
...
fun ViewManager.relativeLayout(): android.widget.RelativeLayout = relativeLayout() {}
...
fun ViewManager.themedRelativeLayout(theme: Int = 0): android.widget.RelativeLayout =
...
fun Context.relativeLayout(): android.widget.RelativeLayout = relativeLayout() {}
inline fun Context.relativeLayout(init: (@AnkoViewDslMarker _RelativeLayout).() -> Unit): android.widget.RelativeLayout {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.RELATIVE_LAYOUT, theme = 0) { init() }
}

fun Context.themedRelativeLayout(theme: Int = 0): android.widget.RelativeLayout =
    themedRelativeLayout(theme) {}
...
fun Activity.relativeLayout(): android.widget.RelativeLayout = relativeLayout() {}
inline fun Activity.relativeLayout(init: (@AnkoViewDslMarker _RelativeLayout).() -> Unit): android.widget.RelativeLayout {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.RELATIVE_LAYOUT, theme = 0) { init() }
}

fun Activity.themedRelativeLayout(theme: Int = 0): android.widget.RelativeLayout =
    themedRelativeLayout(theme) {}
...
fun ViewManager.scrollView(): android.widget.ScrollView = scrollView() {}
...
fun ViewManager.themedScrollView(theme: Int = 0): android.widget.ScrollView =
...
fun Context.scrollView(): android.widget.ScrollView = scrollView() {}
inline fun Context.scrollView(init: (@AnkoViewDslMarker _ScrollView).() -> Unit): android.widget.ScrollView {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.SCROLL_VIEW, theme = 0) { init() }
}

fun Context.themedScrollView(theme: Int = 0): android.widget.ScrollView =
    themedScrollView(theme) {}
...
fun Activity.scrollView(): android.widget.ScrollView = scrollView() {}
inline fun Activity.scrollView(init: (@AnkoViewDslMarker _ScrollView).() -> Unit): android.widget.ScrollView {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.SCROLL_VIEW, theme = 0) { init() }
}

fun Activity.themedScrollView(theme: Int = 0): android.widget.ScrollView =
    themedScrollView(theme) {}
...
fun ViewManager.tableLayout(): android.widget.TableLayout = tableLayout() {}
...
fun ViewManager.themedTableLayout(theme: Int = 0): android.widget.TableLayout =
...
fun Context.tableLayout(): android.widget.TableLayout = tableLayout() {}
inline fun Context.tableLayout(init: (@AnkoViewDslMarker _TableLayout).() -> Unit): android.widget.TableLayout {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.TABLE_LAYOUT, theme = 0) { init() }
}

fun Context.themedTableLayout(theme: Int = 0): android.widget.TableLayout =
    themedTableLayout(theme) {}
...
fun Activity.tableLayout(): android.widget.TableLayout = tableLayout() {}
inline fun Activity.tableLayout(init: (@AnkoViewDslMarker _TableLayout).() -> Unit): android.widget.TableLayout {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.TABLE_LAYOUT, theme = 0) { init() }
}

fun Activity.themedTableLayout(theme: Int = 0): android.widget.TableLayout =
    themedTableLayout(theme) {}
...
fun ViewManager.tableRow(): android.widget.TableRow = tableRow() {}
...
fun ViewManager.themedTableRow(theme: Int = 0): android.widget.TableRow =
...
fun Context.tableRow(): android.widget.TableRow = tableRow() {}
inline fun Context.tableRow(init: (@AnkoViewDslMarker _TableRow).() -> Unit): android.widget.TableRow {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.TABLE_ROW, theme = 0) { init() }
}

fun Context.themedTableRow(theme: Int = 0): android.widget.TableRow =
    themedTableRow(theme) {}
...
fun Activity.tableRow(): android.widget.TableRow = tableRow() {}
inline fun Activity.tableRow(init: (@AnkoViewDslMarker _TableRow).() -> Unit): android.widget.TableRow {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.TABLE_ROW, theme = 0) { init() }
}

fun Activity.themedTableRow(theme: Int = 0): android.widget.TableRow =
    themedTableRow(theme) {}
...
fun ViewManager.textSwitcher(): android.widget.TextSwitcher = textSwitcher() {}
...
fun ViewManager.themedTextSwitcher(theme: Int = 0): android.widget.TextSwitcher =
...
fun Context.textSwitcher(): android.widget.TextSwitcher = textSwitcher() {}
inline fun Context.textSwitcher(init: (@AnkoViewDslMarker _TextSwitcher).() -> Unit): android.widget.TextSwitcher {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.TEXT_SWITCHER, theme = 0) { init() }
}

fun Context.themedTextSwitcher(theme: Int = 0): android.widget.TextSwitcher =
    themedTextSwitcher(theme) {}
...
fun Activity.textSwitcher(): android.widget.TextSwitcher = textSwitcher() {}
inline fun Activity.textSwitcher(init: (@AnkoViewDslMarker _TextSwitcher).() -> Unit): android.widget.TextSwitcher {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.TEXT_SWITCHER, theme = 0) { init() }
}

fun Activity.themedTextSwitcher(theme: Int = 0): android.widget.TextSwitcher =
    themedTextSwitcher(theme) {}
...
fun ViewManager.toolbar(): android.widget.Toolbar = toolbar() {}
...
fun ViewManager.themedToolbar(theme: Int = 0): android.widget.Toolbar =
    themedToolbar(theme) {}
...
fun Context.toolbar(): android.widget.Toolbar = toolbar() {}
inline fun Context.toolbar(init: (@AnkoViewDslMarker _Toolbar).() -> Unit): android.widget.Toolbar {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.TOOLBAR, theme = 0) { init() }
}

fun Context.themedToolbar(theme: Int = 0): android.widget.Toolbar = themedToolbar(theme) {}
...
fun Activity.toolbar(): android.widget.Toolbar = toolbar() {}
inline fun Activity.toolbar(init: (@AnkoViewDslMarker _Toolbar).() -> Unit): android.widget.Toolbar {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.TOOLBAR, theme = 0) { init() }
}

fun Activity.themedToolbar(theme: Int = 0): android.widget.Toolbar = themedToolbar(theme) {}
...
fun ViewManager.viewAnimator(): android.widget.ViewAnimator = viewAnimator() {}
...
fun ViewManager.themedViewAnimator(theme: Int = 0): android.widget.ViewAnimator =
...
fun Context.viewAnimator(): android.widget.ViewAnimator = viewAnimator() {}
inline fun Context.viewAnimator(init: (@AnkoViewDslMarker _ViewAnimator).() -> Unit): android.widget.ViewAnimator {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.VIEW_ANIMATOR, theme = 0) { init() }
}

fun Context.themedViewAnimator(theme: Int = 0): android.widget.ViewAnimator =
    themedViewAnimator(theme) {}
...
fun Activity.viewAnimator(): android.widget.ViewAnimator = viewAnimator() {}
inline fun Activity.viewAnimator(init: (@AnkoViewDslMarker _ViewAnimator).() -> Unit): android.widget.ViewAnimator {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.VIEW_ANIMATOR, theme = 0) { init() }
}

fun Activity.themedViewAnimator(theme: Int = 0): android.widget.ViewAnimator =
    themedViewAnimator(theme) {}
...
fun ViewManager.viewSwitcher(): android.widget.ViewSwitcher = viewSwitcher() {}
...
fun ViewManager.themedViewSwitcher(theme: Int = 0): android.widget.ViewSwitcher =
...
fun Context.viewSwitcher(): android.widget.ViewSwitcher = viewSwitcher() {}
inline fun Context.viewSwitcher(init: (@AnkoViewDslMarker _ViewSwitcher).() -> Unit): android.widget.ViewSwitcher {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.VIEW_SWITCHER, theme = 0) { init() }
}

fun Context.themedViewSwitcher(theme: Int = 0): android.widget.ViewSwitcher =
    themedViewSwitcher(theme) {}
...
fun Activity.viewSwitcher(): android.widget.ViewSwitcher = viewSwitcher() {}
inline fun Activity.viewSwitcher(init: (@AnkoViewDslMarker _ViewSwitcher).() -> Unit): android.widget.ViewSwitcher {
    return ankoView(`$$Anko$Factories$Sdk28ViewGroup`.VIEW_SWITCHER, theme = 0) { init() }
}

fun Activity.themedViewSwitcher(theme: Int = 0): android.widget.ViewSwitcher =
    themedViewSwitcher(theme) {}
