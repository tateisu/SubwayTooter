...
object TagSet {
	...
	private val table = "tag_set"
	private val COL_TIME_SAVE = "time_save"
	private val COL_TAG = "tag" // タグ。先頭の#を含まない
	
	private val prefix_search_where = "$COL_TAG like ? escape '$'"
	...
	fun searchPrefix(prefix : String, limit : Int) : ArrayList<CharSequence> {
		try {
			...
			App1.database.query(table, null, prefix_search_where, where_arg, null, null, COL_TAG + " asc limit " + limit)
				.use{
					cursor->
